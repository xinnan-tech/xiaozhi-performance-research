...
| 测试方法                                                                                             | 测试地点      | 测试时间             | 宽带运营商 |
| ------------------------------------------------------------------------------------------------ | --------- | ---------------- | ----- |
| [点击查看](https://github.com/xinnan-tech/xiaozhi-esp32-server/blob/main/docs/performance_tester.md) | 广东省广州市海珠区 | 2026年8月7日 10:41 | 中国联通  |

#### 4.2.2 测试结果

| 模型名称                        | 指标名称                | 指标值    |
| --------------------------- | ------------------- | ------ |
| qwen3-8b                    | 小智超长角色提示词下的首Token时间 | 0.587秒 |
| qwen3.6-flash               | 小智超长角色提示词下的首Token时间 | 0.600秒 |
| qwen3.6-35b-a3b             | 小智超长角色提示词下的首Token时间 | 0.601秒 |
| qwen-flash-2025-07-28       | 小智超长角色提示词下的首Token时间 | 0.670秒 |
...
| deepseek-v4-flash           | 小智超长角色提示词下的首Token时间 | 0.901秒 |
| qwen3-max                   | 小智超长角色提示词下的首Token时间 | 0.924秒 |
| qwen3-max-2026-01-23        | 小智超长角色提示词下的首Token时间 | 0.938秒 |
| kimi-k2.5                   | 小智超长角色提示词下的首Token时间 | 0.984秒 |
| glm-4-flash                 | 小智超长角色提示词下的首Token时间 | 1.112秒 |
